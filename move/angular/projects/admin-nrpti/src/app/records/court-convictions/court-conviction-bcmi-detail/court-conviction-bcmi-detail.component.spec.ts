...
import { CourtConvictionBCMIDetailComponent } from './court-conviction-bcmi-detail.component';
...
describe('CourtConvictionBCMIDetailComponent', () => {
  const testBedHelper = new TestBedHelper<CourtConvictionBCMIDetailComponent>(CourtConvictionBCMIDetailComponent);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CourtConvictionBCMIDetailComponent],
      providers: [
        DatePipe,
