...
@Injectable()
export class CourtConvictionResolver implements Resolve<Observable<SearchResults[]>> {
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<SearchResults[]> {
    ...
    return this.factoryService.getRecordWithFlavours(courtConvictionId, 'CourtConviction');
  }
}
