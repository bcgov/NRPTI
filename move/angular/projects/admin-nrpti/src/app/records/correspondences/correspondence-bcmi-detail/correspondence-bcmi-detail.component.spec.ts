...
import { CorrespondenceBCMIDetailComponent } from './correspondence-bcmi-detail.component';
...
describe('CorrespondenceBCMIDetailComponent', () => {
  const testBedHelper = new TestBedHelper<CorrespondenceBCMIDetailComponent>(CorrespondenceBCMIDetailComponent);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CorrespondenceBCMIDetailComponent],
      providers: [
        DatePipe,
