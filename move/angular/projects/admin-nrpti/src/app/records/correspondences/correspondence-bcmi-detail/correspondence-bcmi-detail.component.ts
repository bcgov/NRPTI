...
import { CorrespondenceBCMI } from '../../../../../../common/src/app/models/bcmi/correspondence-bcmi';
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new CorrespondenceBCMI(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new CorrespondenceBCMI(response);
        this.isPublished = this.isRecordPublished();
