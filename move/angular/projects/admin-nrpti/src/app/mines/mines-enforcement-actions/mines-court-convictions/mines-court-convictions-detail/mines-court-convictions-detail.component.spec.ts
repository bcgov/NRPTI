...
import { MinesCourtConvictionsDetailComponent } from './mines-court-convictions-detail.component';

describe('MinesCourtConvictionsDetailComponent', () => {
  const testBedHelper = new TestBedHelper<MinesCourtConvictionsDetailComponent>(MinesCourtConvictionsDetailComponent);
