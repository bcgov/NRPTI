...
/**
 * AMS csv base record type handler that can be used directly, or extended if customizations are needed.
 *
...
class BaseRecordUtils {
  ...
  /**
   * Transform an ams-csv row into a NRPTI record.
   *
   * Note: Only transforms common fields found in ALL supported ams-csv types.
   *       To include other values, extend this class and adjust the object returned by this function as needed.
   *
   * @param {object} csvRow ams-csv row (required)
