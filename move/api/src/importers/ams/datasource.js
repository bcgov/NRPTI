const defaultLog = require('../../utils/logger')('ams-csv-datasource');
const RECORD_TYPE = require('../../utils/constants/record-type-enum');

class AmsCsvDataSource {
  /**
  ...
  /**
   * Run the AMS csv importer.
   *
   * @returns final status of importer
   * @memberof AmsCsvDataSource
   */
  async run() {
    defaultLog.info('run - import ams-csv');
  ...
  /**
   * Supported AMS csv record type configs.
   *
...
module.exports = AmsCsvDataSource;
