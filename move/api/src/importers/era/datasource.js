const defaultLog = require('../../utils/logger')('era-csv-datasource');
const RECORD_TYPE = require('../../utils/constants/record-type-enum');

class EraCsvDataSource {
  /**
  ...
  /**
   * Run the era csv importer.
   *
   * @returns final status of importer
   * @memberof EraCsvDataSource
   */
  async run() {
    defaultLog.info('run - import era-csv');
  ...
  /**
   * Supported Era csv record type configs.
   *
...
module.exports = EraCsvDataSource;
