...
*/
  try {
    const actsRegulationsMappingCollection = mClient.collection('acts_regulations_mapping');
        ...
        for (let act in actsRegulationsMappingData) 
         {
            await actsRegulationsMappingCollection.insertOne(
              { 
                _schemaName: 'ActsRegulationsMapping',
                actCode: 'ACT_' + i,
                actName: act,
                regulations: actsRegulationsMappingData[act],
                read: ['sysadmin'],
                write: ['sysadmin'],
                dateAdded: new Date(),
                dateUpdated: null,
              ...
              console.log(` **** Add the Acts Regulations Mapping ${act} into ActsRegulationsMapping collection ****`);
           i++;   
        }
