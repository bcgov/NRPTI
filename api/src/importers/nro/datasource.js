...
class NroCsvDataSource {
  ...
  /**
   * Run the NRO csv importer.
   *
   * @returns final status of importer
   * @memberof NroCsvDataSource
   */
  async run() {
    defaultLog.info('run - import nris-flnr-csv');
  ...
  /**
   * Supported NRO csv record type configs.
   *
...
module.exports = NroCsvDataSource;
