...
exports.createMaster = async function(args, res, next, incomingObj, flavourIds) {
  ...
  incomingObj.issuedTo && incomingObj.issuedTo.fullName && (order.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (order.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo && incomingObj.issuedTo.anonymous && (order.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createLNG = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo && incomingObj.issuedTo.fullName && (orderLNG.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (orderLNG.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (orderLNG.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createNRCED = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo.type && (orderNRCED.issuedTo.type = incomingObj.issuedTo.type);
  incomingObj.issuedTo.companyName && (orderNRCED.issuedTo.companyName = incomingObj.issuedTo.companyName);
  incomingObj.issuedTo.firstName && (orderNRCED.issuedTo.firstName = incomingObj.issuedTo.firstName);
  incomingObj.issuedTo.middleName && (orderNRCED.issuedTo.middleName = incomingObj.issuedTo.middleName);
  incomingObj.issuedTo.lastName && (orderNRCED.issuedTo.lastName = incomingObj.issuedTo.lastName);
  incomingObj.issuedTo.fullName && (orderNRCED.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo.dateOfBirth && (orderNRCED.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo.anonymous && (orderNRCED.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
