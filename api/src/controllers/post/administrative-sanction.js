...
exports.createMaster = async function(args, res, next, incomingObj, flavourIds) {
  ...
  incomingObj.issuedTo &&
    ...
    (administrativeSanction.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (administrativeSanction.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (administrativeSanction.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createLNG = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo &&
    incomingObj.issuedTo.fullName &&
    (administrativeSanctionLNG.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (administrativeSanctionLNG.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (administrativeSanctionLNG.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createNRCED = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo &&
    incomingObj.issuedTo.fullName &&
    (administrativeSanctionNRCED.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (administrativeSanctionNRCED.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (administrativeSanctionNRCED.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
