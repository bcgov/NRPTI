...
exports.createMaster = async function(args, res, next, incomingObj, flavourIds) {
  ...
  incomingObj.issuedTo && incomingObj.issuedTo.fullName && (warning.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (warning.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (warning.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createLNG = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo &&
    ...
    (warningLNG.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (warningLNG.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (warningLNG.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
...
exports.createNRCED = async function(args, res, next, incomingObj) {
  ...
  incomingObj.issuedTo &&
    incomingObj.issuedTo.fullName &&
    (warningNRCED.issuedTo.fullName = incomingObj.issuedTo.fullName);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.dateOfBirth &&
    (warningNRCED.issuedTo.dateOfBirth = incomingObj.issuedTo.dateOfBirth);
  incomingObj.issuedTo &&
    incomingObj.issuedTo.anonymous &&
    (warningNRCED.issuedTo.anonymous = incomingObj.issuedTo.anonymous);
