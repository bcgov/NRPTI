...
exports.getAllActsAndRegulationsFromDB = async function() {
  try {
    ...
    for (let actRegulations of actsRegulationsMapResponse) {
      actsRegulationsMap[actRegulations['actCode']] = {
        actName: actRegulations['actName'],
        regulations: actRegulations['regulations']
      };
    }
...
exports.parseTitleFromXML = function(responseXML) {
  ...
  try {
    ...
    if (titleStartIndex >= 0 && titleEndIndex >= 0) {
      //indexOf() returns -1 if no matches are found
