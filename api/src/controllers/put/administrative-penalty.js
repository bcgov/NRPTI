...
exports.editLNG = function (args, res, next, incomingObj) {
  ...
  const flavourId = incomingObj.AdministrativePenaltyLNG ? incomingObj.AdministrativePenaltyLNG._id : null
  updateObj = BusinessLogicManager.applyBusinessLogicOnPut(updateObj, sanitizedObj, flavourId, 'AdministrativePenaltyLNG');
...
exports.editNRCED = function (args, res, next, incomingObj) {
  ...
  const flavourId = incomingObj.AdministrativePenaltyNRCED ? incomingObj.AdministrativePenaltyNRCED._id : null
  updateObj = BusinessLogicManager.applyBusinessLogicOnPut(updateObj, sanitizedObj, flavourId, 'AdministrativePenaltyNRCED');
