...
exports.editRecord = async function(args, res, next, incomingObj) {
  ...
  try {
    const isAnonymous = QueryUtils.isRecordAnonymous(savedCourtConviction);
    ...
    } else if (savedCourtConviction) {
      savedCourtConviction.documents.forEach(docId => {
        DocumentController.publishDocument(savedCourtConviction._id, docId, args.swagger.params.auth_payload);
      });
    }
