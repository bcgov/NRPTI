...
describe('EpicDataSource', () => {
  describe('constructor', () => {
    it('sets params', () => {
      const epicDataSource = new EpicDataSource({ params: 1 });
    ...
    it('sets auth_payload', () => {
      const epicDataSource = new EpicDataSource({ params: 1 }, { auth_payload: 'some payload' });
  ...
  describe('updateRecordType', () => {
    it('catches any thrown exceptions and returns gracefully', async () => {
      ...
      expect(recordTypeStatus).toEqual({
        ...
        error: JSON.stringify(new Error('updateRecordType - unexpected error!')),
        itemsProcessed: 0,
        itemTotal: 0,
        url: ''
      });
    ...
    it('calls all functions necessary to update epic records for the given type', async () => {
      ...
      const epicDataSource = new EpicDataSource({ param1: 1 });
