 ...
 *
 * @export
 * @class CorrespondenceNRCED
 */
export class CorrespondenceNRCED {
  _id: string;
  _schemaName: string;
  ...
  constructor(obj?: any) {
    ...
    this._schemaName = (obj && obj._schemaName) || 'CorrespondenceNRCED';
    ...
    this.recordType = (obj && obj.recordType) || 'Correspondence';
