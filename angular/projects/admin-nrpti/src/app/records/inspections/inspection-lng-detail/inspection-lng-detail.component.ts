...
import { InspectionLNG } from '../../../../../../common/src/app/models/lng/inspection-lng';
...
@Component({
  ...
  templateUrl: './inspection-lng-detail.component.html',
  styleUrls: ['./inspection-lng-detail.component.scss']
})
export class InspectionLNGDetailComponent extends RecordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new InspectionLNG(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new InspectionLNG(response);
        this.isPublished = this.isRecordPublished();
