...
import { CertificateLNG } from '../../../../../../common/src/app/models/lng/certificate-lng';
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new CertificateLNG(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new CertificateLNG(response);
        this.isPublished = this.isRecordPublished();
