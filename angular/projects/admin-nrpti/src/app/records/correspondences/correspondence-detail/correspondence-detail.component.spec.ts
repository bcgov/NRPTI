...
describe('CorrespondenceDetailComponent', () => {
  const testBedHelper = new TestBedHelper<CorrespondenceDetailComponent>(CorrespondenceDetailComponent);
  ...
  beforeEach((() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CorrespondenceDetailComponent, RecordDetailDirective],
      providers: [
        DatePipe,
