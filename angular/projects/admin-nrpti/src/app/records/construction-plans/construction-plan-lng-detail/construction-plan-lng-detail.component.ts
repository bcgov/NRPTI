...
import { ConstructionPlanLNG } from '../../../../../../common/src/app/models/lng';
...
@Component({
  ...
  templateUrl: './construction-plan-lng-detail.component.html',
  styleUrls: ['./construction-plan-lng-detail.component.scss']
})
export class ConstructionPlanLNGDetailComponent extends RecordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new ConstructionPlanLNG(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new ConstructionPlanLNG(response);
        this.isPublished = this.isRecordPublished();
