...
import { DamSafetyInspectionAddEditComponent } from './dam-safety-inspection-add-edit.component';
...
describe('DamSafetyInspectionAddEditComponent', () => {
  const testBedHelper = new TestBedHelper<DamSafetyInspectionAddEditComponent>(DamSafetyInspectionAddEditComponent);
