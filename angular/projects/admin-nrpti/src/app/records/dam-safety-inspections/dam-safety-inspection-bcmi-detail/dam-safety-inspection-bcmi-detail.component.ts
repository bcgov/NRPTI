...
import { DamSafetyInspectionBCMI } from '../../../../../../common/src/app/models/bcmi/dam-safety-inspection-bcmi';
...
@Component({
  standalone: false,
  selector: 'app-dam-safety-inspection-bcmi-detail',
  templateUrl: './dam-safety-inspection-bcmi-detail.component.html',
  styleUrls: ['./dam-safety-inspection-bcmi-detail.component.scss']
})
export class DamSafetyInspectionBCMIDetailComponent extends RecordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new DamSafetyInspectionBCMI(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new DamSafetyInspectionBCMI(response);
        this.isPublished = this.isRecordPublished();
