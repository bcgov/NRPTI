...
import { AdministrativePenaltyBCMI } from '../../../../../../common/src/app/models/bcmi/administrative-penalty-bcmi';
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new AdministrativePenaltyBCMI(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new AdministrativePenaltyBCMI(response);
        this.isPublished = this.isRecordPublished();
