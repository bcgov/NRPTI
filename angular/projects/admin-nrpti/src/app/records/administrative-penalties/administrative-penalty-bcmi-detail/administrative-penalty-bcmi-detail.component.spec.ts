...
import { AdministrativePenaltyBCMIDetailComponent } from './administrative-penalty-bcmi-detail.component';
...
describe('AdministrativePenaltyBCMIDetailComponent', () => {
  const testBedHelper = new TestBedHelper<AdministrativePenaltyBCMIDetailComponent>(
  ...
  beforeEach((() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AdministrativePenaltyBCMIDetailComponent],
      providers: [
        DatePipe,
