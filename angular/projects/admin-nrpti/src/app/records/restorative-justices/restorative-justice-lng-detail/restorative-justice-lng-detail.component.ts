...
@Component({
  selector: 'app-restorative-justice-lng-detail',
  templateUrl: './restorative-justice-lng-detail.component.html',
  styleUrls: ['./restorative-justice-lng-detail.component.scss']
})
export class RestorativeJusticeLNGDetailComponent extends RecordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new RestorativeJusticeLNG(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new RestorativeJusticeLNG(response);
        this.isPublished = this.isRecordPublished();
