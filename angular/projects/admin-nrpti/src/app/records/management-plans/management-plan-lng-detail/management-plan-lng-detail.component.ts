...
import { ManagementPlanLNG } from '../../../../../../common/src/app/models/lng/management-plan-lng';
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new ManagementPlanLNG(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new ManagementPlanLNG(response);
        this.isPublished = this.isRecordPublished();
