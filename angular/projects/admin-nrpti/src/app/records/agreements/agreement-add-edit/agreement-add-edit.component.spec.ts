...
import { AgreementAddEditComponent } from './agreement-add-edit.component';
...
describe('AgreementAddEditComponent', () => {
  const testBedHelper = new TestBedHelper<AgreementAddEditComponent>(AgreementAddEditComponent);
