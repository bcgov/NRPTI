...
import { CertificateAmendmentBCMIDetailComponent } from './certificate-amendments-bcmi-detail.component';
...
describe('CertificateAmendmentBCMIDetailComponent', () => {
  const testBedHelper = new TestBedHelper<CertificateAmendmentBCMIDetailComponent>
  ...
  beforeEach((() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CertificateAmendmentBCMIDetailComponent],
      providers: [
        DatePipe,
