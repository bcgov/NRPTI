...
import { CertificateAmendmentBCMI } from '../../../../../../common/src/app/models/bcmi/certificate-amendment-bcmi';
...
@Component({
  selector: 'app-certificate-amendment-bcmi-detail',
  templateUrl: './certificate-amendments-bcmi-detail.component.html',
  styleUrls: ['./certificate-amendments-bcmi-detail.component.scss']
})
export class CertificateAmendmentBCMIDetailComponent extends RecordComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    if (!this.data) {
      this.route.data.pipe(takeUntil(this.ngUnsubscribe)).subscribe((res: any) => {
        ...
        this.data = records && records[0] && new CertificateAmendmentBCMI(records[0]);
  ...
  publish(): void {
    this.factoryService
      ...
      .subscribe(response => {
        ...
        this.data = new CertificateAmendmentBCMI(response);
        this.isPublished = this.isRecordPublished();
