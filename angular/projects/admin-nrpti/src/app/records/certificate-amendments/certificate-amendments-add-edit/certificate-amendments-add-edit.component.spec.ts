...
import { CertificateAmendmentAddEditComponent } from './certificate-amendments-add-edit.component';
...
describe('CertificateAddEditComponent', () => {
  const testBedHelper = new TestBedHelper<CertificateAmendmentAddEditComponent>(CertificateAmendmentAddEditComponent);
