...
import { AdministrativeSanctionLNGDetailComponent } from './administrative-sanction-lng-detail.component';
...
describe('AdministrativeSanctionLNGDetailComponent', () => {
  const testBedHelper = new TestBedHelper<AdministrativeSanctionLNGDetailComponent>(
  ...
  beforeEach((() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AdministrativeSanctionLNGDetailComponent],
      providers: [
        DatePipe,
