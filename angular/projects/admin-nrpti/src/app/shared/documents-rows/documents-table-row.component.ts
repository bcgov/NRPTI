...
@Component({
  selector: 'tr[app-documents-table-row]',
  templateUrl: './documents-table-row.component.html',
  styleUrls: ['./documents-table-row.component.scss']
})
export class DocumentsTableRowComponent extends TableRowComponent {
